...
var tool_slot_node = preload("res://player/inventory/equipment/ToolSlot.tscn")
var selected_icon = preload("res://player/inventory/equipment/equipment_slot_selected.png")
var icon = preload("res://player/inventory/equipment/equipment_slot.png")
